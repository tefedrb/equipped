...
const CreateCompanyMenu = (props) => {
    const [menuState, updateMenuState] = useState({name: null, password: null, type: 'media'});
    ...
    return  (
        <div className={`create-company-menu ${showCreateCompMenu}`}>
            <Div>
                ...
                <Button onClick={props.toggleCreateCompany}>Back</Button>
            </Div>
        </div>
    )
};
